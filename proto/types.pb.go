...
type TxInput struct {
	...
	// the output we want spend
	PrevTxHash []byte `protobuf:"bytes,1,opt,name=prevTxHash,proto3" json:"prevTxHash,omitempty"`
	// the index of the output of the pervious transaction we want to spend
...
func (x *TxOutput) GetAddress() int64 {
	if x != nil {
		return x.Address
	}
	return 0
...
type Transaction struct {
	...
	Outouts []*TxOutput `protobuf:"bytes,3,rep,name=outouts,proto3" json:"outouts,omitempty"`
}
...
func (x *Transaction) GetOutouts() []*TxOutput {
	if x != nil {
		return x.Outouts
	}
	return nil
...
var file_proto_types_proto_rawDesc = []byte{
	...
	0x65, 0x78, 0x12, 0x1c, 0x0a, 0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x6b, 0x65, 0x79, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x6b, 0x65, 0x79,
	...
	0x01, 0x28, 0x03, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x6e, 0x0a, 0x0b,
	...
	0x06, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x12, 0x23, 0x0a, 0x07, 0x6f, 0x75, 0x74, 0x6f, 0x75,
	0x74, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x54, 0x78, 0x4f, 0x75, 0x74,
	0x70, 0x75, 0x74, 0x52, 0x07, 0x6f, 0x75, 0x74, 0x6f, 0x75, 0x74, 0x73, 0x42, 0x24, 0x5a, 0x22,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x41, 0x6c, 0x69, 0x2d, 0x41,
	0x73, 0x73, 0x61, 0x72, 0x2f, 0x47, 0x6f, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x2f, 0x70, 0x72, 0x6f,
...
var file_proto_types_proto_depIdxs = []int32{
	...
	3, // 3: Transaction.outouts:type_name -> TxOutput
